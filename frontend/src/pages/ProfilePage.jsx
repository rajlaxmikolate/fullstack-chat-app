  ...
  return (
   <div className="h-screen pt-20 flex justify-center items-center">
    <div className="max-w-xl w-full mx-auto p-6">
      <div className='bg-base-300 rounded-xl p-6 flex flex-col items-center w-full'>
        <div className='text-center w-full'>
          ...
          <div className='space-y-6 w-full'>
            ...
            <div className='space-y-1.5 w-full'>
              ...
              <p className='px-4 py-2.5 bg-base-200 rounded-lg border w-full'>{authUser?.email}</p>
            </div>
          </div>
